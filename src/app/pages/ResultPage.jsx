import { Heart, MessageCircle, Smile, TrendingUp, Users, RefreshCw } from "lucide-react";
export default function Result({ result, resetTest, getPersonalityDescription }) {
    return (
        <div className="max-w-6xl mx-auto p-4 py-8">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            {/* Compatibility Score */}
            <div className="bg-linear-to-r from-purple-500 to-pink-500 text-white rounded-3xl p-10 mb-10 shadow-lg">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                { label: 'Kepribadian', key: 'personality', icon: Smile },
                { label: 'Komunikasi & Konflik', key: 'communication', icon: MessageCircle },
                { label: 'Nilai & Love Language', key: 'values', icon: Heart },
                { label: 'Gaya Hidup', key: 'lifestyle', icon: Users }
              ].map((item, idx) => {
            ...
            <div className="text-center">
              <button
                onClick={resetTest}
                className="px-8 py-4 bg-linear-to-r from-purple-500 to-pink-500 text-white text-lg font-semibold rounded-xl shadow hover:from-purple-600 hover:to-pink-600 transition-all flex items-center justify-center gap-2 mx-auto"
              >
