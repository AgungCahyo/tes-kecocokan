...
import { Question, ScaleOption, PersonalityDescription, PersonalityProfile, CompatibilityResult } from '@/types';
...
export const calculateCompatibility = (p1: PersonalityProfile, p2: PersonalityProfile): CompatibilityResult => {
  const breakdown = {
    personality: 0,
    communication: 0,
    values: 0,
